...
let userInput = +prompt("Enter the id", 1);
...
let findId = productDetails.find(
  (productDetail) => productDetail.id == userInput
);
console.log(findId);
...
let [userOne, userTwo] = new Set(["john", "jack"]);
console.log(userOne);

let [, , skipFruits] = fruits;
console.log(skipFruits);
...
let subjects = ["English", "Maths", "Physics", "Chemistry", "Computer"];

let [subjectOne, subjectTwo, ...restSubjects] = subjects;
